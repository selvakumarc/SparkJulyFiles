...
val archers_defualt = util.Try(shipMap("Archer")) getOrElse ("avengers")
shipMap.get("Archer")
val archers = util.Try(shipMap("Archer")) getOrElse (throw new RuntimeException("KEY NOT FOUND IN SHIP_MAP"))
    }
